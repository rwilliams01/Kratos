...
KratosGroundFreezingApplication::KratosGroundFreezingApplication():
    KratosApplication("GroundFreezingApplication")
    {}

void KratosGroundFreezingApplication::Register()
{
     KRATOS_INFO("") << "Initializing KratosGroundFreezingApplication..." << std::endl;
